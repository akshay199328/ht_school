$(document).ready(function(){
  ...
  $('#button-menu').click(function(){
    ...
    if($('#button-menu').attr('class') == 'bi bi-bars' ){
      ...
      $('.navegacion').css({'width':'100%', 'background':'rgba(0,0,0,.5)', 'display' : 'none'}); // Mostramos al fondo transparente
      ...
      $('.navegacion').css({'width':'0%', 'background':'rgba(0,0,0,.0)', 'display' : 'block'}); // Ocultamos el fonto transparente
  ...
  $('.navegacion .submenu li.go-back').click(function(){
    ...
    $(this).parent().parent().css({'display' : 'none'}); // Ocultamos el submenu
  ...
  $('.navegacion .menu li.title-menu svg').click(function(){
    // alert("CLOSE");
    $(this).parent().parent().parent().css({, 'display' : 'block'}); // Ocultamos el submenu
