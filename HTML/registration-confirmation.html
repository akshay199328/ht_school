...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <style>
            ...
            .reg-bg {
                background-image: url(assets/img/registration-confirm.png);
                height: 346px;
                background-size: 107%;
...
.aBn {
        ...
        <style>
            ...
            .middle-wrap{padding: 0 124px;text-align: center;}
            .logo a img{width:371px;height:100px}
            @media screen and (max-width: 767px) {
                .middle-wrap{padding: 0 40px;}
                .logo a img{width: 293px;height: 77px;}
            }
        </style>
    </head>
        ...
        <center style="width: 100%; background-color: #f1f1f1;">
            ...
            <div style="max-width: 650px; margin: 0 auto; border: 2px solid #ddd; border-bottom: 0;" class="email-container">
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                    <tr>
                        <td valign="top" class="bg_light" style="padding: 30px 2.5em 0 2.5em;">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
                                        <h1 style="text-align: center; font-weight: bold; font-size: 45px; margin-bottom: 0px;">Welcome To</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="logo" style="text-align: center; margin-bottom: 26px;">
                                        <a href="#"><img src="assets/img/register-mailer-logo.png" style="" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td valign="middle" class="hero bg_light" style="padding: 0em 0 0px 0;">
                            <table>
                                <tr>
                                    <td>
                                        <div class="text middle-wrap">
                                            <h2 style="font-size: 28px; font-family: Arial; font-weight: normal; text-align: center; margin-bottom: 30px;">India's Learning Playground!</h2>
                                            <a href="#" style="background-color: #000000; font-size: 16px; text-transform: capitalize; padding: 11px 30px; color: #fff; font-weight: 600; margin-bottom: 30px; display: inline-block;">
                                                Explore All Courses
                                            </a>
                                            <p style="font-family: Arial; font-size: 18px; color: #000; text-align: left; margin-top: 0;">Discover the fun world of learning that awaits you!</p>
                                            <p style="font-family: Arial; font-size: 18px; margin-top: 0; margin-bottom: 0px; color: #000; text-align: left;">Happy Learning!</p>
                                            <p style="font-family: Arial; font-size: 18px; margin-top: 0; margin-bottom: 0; font-weight: bold; color: #000; margin-bottom: 0; text-align: left;">Team HT School</p>
