...
$slugcburl='ganesh-acharya-dancing-classes';
...
if ( $fetchedQuery->found_posts <= 0 ){
  ...
  $responseImg = $responseDecode->a_thumb;
  $image_url = $wpcs_options['cs_api_url'].'/album_image/'.$responseImg;
...
//the post is valid
  ...
  <script type="text/javascript">
    let cName = "<?php echo $responseDecode->meta_title; ?>"
    alert(cName + " Name Course is Already Existing");
  </script>
  <?php
}
