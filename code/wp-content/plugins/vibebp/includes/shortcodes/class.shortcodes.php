    			...
    			if(vibebp_get_setting('service_workers')){
    				...
    				add_action('wp_head',function(){
    					...
    					if(file_exists($site_root.'/manifest.json')){
	    					...
	    					echo '<link rel="manifest" href="'.site_url().'/manifest.json'.'"><meta name="theme-color" content="'.$theme_color.'"><meta name="theme-color" content="'.$theme_color.'"><meta name="msapplication-TileColor" content="'.$theme_color.'" /><meta name="msapplication-config" content="none"/><meta name="msapplication-navbutton-color" content="'.$theme_color.'">';
	    				}
    	...
    	add_action('wp_footer',function(){
    		...
    		if(file_exists($site_root.'/firebase-messaging-sw.js')){
    			if(vibebp_get_setting('service_workers')){
					...
					$scope = apply_filters('vibebp_service_worker_js_scope',$scope,$atts,$content);
