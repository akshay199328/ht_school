...
class WPF_Batch {
	...
	public function export_options( $options ) {
		...
		$core_options = array(
			'users_cid_sync' => array(
				...
				'title'     => __( 'Users (contact IDs)', 'wp-fusion' ),
	...
	public function batch_status_bar() {
		...
		echo '<p><span class="dashicons dashicons-update-alt spin"></span><span class="title"><strong>' . __( 'Background operation running:', 'wp-fusion' ) . '</strong></span> <span class="status">';
		...
		if ( $active ) {
			echo __( 'Processing', 'wp-fusion' ) . ' ' . $done . ' / ' . $total . ' ' . $title . ' ';
		}

		echo '</span><a id="cancel-batch" class="btn btn-default btn-xs">' . __( 'Cancel', 'wp-fusion' ) . '</a></p>';
		echo '</div>';
