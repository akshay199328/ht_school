...
class WPF_HighLevel_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['highlevel_api_key'] = array(
			...
			'desc'        => sprintf( __( 'Enter your HighLevel API Key. You can find it in the %1$sCompany Settings%2$s of your HighLevel account.', 'wp-fusion' ), '<a href="https://help.gohighlevel.com/support/solutions/articles/48000982605-company-settings" target="_blank">', '</a>' ),
			'type'        => 'api_validate',
			'section'     => 'setup',
			'class'       => 'api_key',
