...
class WPF_MailChimp_Admin {
	...
	public function register_settings( $settings, $options ) {
		...
		$new_settings['mc_default_list'] = array(
			...
			'desc'        => __( 'Select an audience to use for WP Fusion. If you change the audience, you\'ll need to Resynchronize from the Setup tab to update your available fields and tags.', 'wp-fusion' ),
			'type'        => 'select',
