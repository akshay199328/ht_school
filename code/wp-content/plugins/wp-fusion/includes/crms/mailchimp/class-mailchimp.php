				...
				if ( isset( $body->errors ) ) {
					...
					foreach ( $body->errors as $error ) {
						...
						if ( 'Please enter a value' == $error->message ) {
							$message .= ' (this error message means that ' . $error->field . ' is a required field in Mailchimp, but your API call did not contain this field, so it was rejected. To fix this, make sure that ' . $error->field . ' is not a required field.';
						}
