...
class WPF_MemberPress extends WPF_Integrations_Base {
	...
	public function subscription_status_changed( $old_status, $new_status, $subscription ) {
		...
		if ( 'active' == $new_status ) {
			...
			$remove_tags = array_merge( $remove_tags, $settings['apply_tags_cancelled'], $settings['apply_tags_expired'], $settings['apply_tags_suspended'] );
	...
	public function output_product_content_tab( $product ) {
		...
		echo '<br /<br /><label><strong>' . __( 'Apply Tags - Paused', 'wp-fusion' ) . ':</strong></label><br />';
		...
		echo '<br /<br /><label><strong>' . __( 'Apply Tags - Upgraded', 'wp-fusion' ) . ':</strong></label><br />';
		...
		echo '<br /><span class="description"><small>' . __( 'Apply these tags when a subscription is upgraded to this membership level.', 'wp-fusion' ) . '</small></span><br />';

		// Downgraded

		echo '<br /<br /><label><strong>' . __( 'Apply Tags - Downgraded', 'wp-fusion' ) . ':</strong></label><br />';
		...
		echo '<br /><span class="description"><small>' . __( 'Apply these tags when a subscription is downgraded to this membership level.', 'wp-fusion' ) . '</small></span>';
