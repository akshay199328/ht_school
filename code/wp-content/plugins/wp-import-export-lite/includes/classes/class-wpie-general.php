...
class WPIE_General {
        ...
        private static function wpie_load_msg() {
                return array(
                        ...
                        "wpiePremiumFeatureOnly" => __( "You have chosen Premium Export Type. Please upgrade to premium.", 'wp-import-export-lite' ),
                        "wpieImportPremiumFeatureOnly" => __( "You have chosen Premium Import Type. Please upgrade to premium.", 'wp-import-export-lite' )
                );
        }
