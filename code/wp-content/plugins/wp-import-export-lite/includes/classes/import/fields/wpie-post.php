        ...
        function wpie_import_post_search_existing_item( $sections = "", $wpie_import_type = "" ) {
                ...
                <div class="wpie_field_mapping_container_element">
                        ...
                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <label for="wpie_existing_item_search_logic_cf" class="wpie_radio_label"><?php esc_html_e( 'Custom Field', 'wp-import-export-lite' ); ?></label>
                                <div class="wpie_radio_container">
                                ...
                                <div class="wpie_radio_container">
                                        ...
                                        <?php if ( $wpie_import_type == "product" ) { ?>
                                                ...
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_catalog_visibility" class="wpie_checkbox_label"><?php esc_html_e( 'Catalog Visibility', 'wp-import-export-lite' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_featured_status" class="wpie_checkbox_label"><?php esc_html_e( 'Featured Status', 'wp-import-export-lite' ); ?></label>
                                                </div>
                                                ...
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_attributes" class="wpie_checkbox_label"><?php esc_html_e( 'Attributes', 'wp-import-export-lite' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_update_attributes_all" class="wpie_radio_label"><?php esc_html_e( 'Update all Attributes', 'wp-import-export-lite' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
