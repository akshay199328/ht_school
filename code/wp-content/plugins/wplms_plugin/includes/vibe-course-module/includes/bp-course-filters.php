...
class bp_course_filters{
    ...
    private function __construct(){
        ...
        add_filter('wplms_drip_value',array($this,'evaluate_course_drip'),99,5);
    ...
    function wplms_before_course_status_api($stop,$course_id,$user_id){
    	$precourse=get_post_meta($course_id,'vibe_pre_course',true);
      	...
      	if(!$cflag){
          	$stop = array('icon'=>'vicon-lock','error_code'=>'precourse','error_message'=>_x('Please complete all pre-requied course first','','wplms'));
      	}
    ...
    function evaluate_course_drip($value,$pre_unit_id,$course_id,$unit_id,$user_id=null){
