jQuery(document).ready(function($) {
    ...
    jQuery('body').delegate('.meta_box_repeatable_remove','click', function(){
    ...
    jQuery('.meta_box_repeatable').sortable({
        ...
        // repeatable fields
    jQuery('body').delegate('.meta_box_sliders_add','click', function() {
        // clone
    ...
    jQuery('body').delegate('.meta_box_sliders_remove','click', function(){ 
