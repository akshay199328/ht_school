      ...
      <div class="home-copy">
        ...
        <?php
          ...
          foreach($course_category_terms as $term){
            ...
            $cat_img = wp_get_attachment_image($thumbnail_id);
            ?>
            <li class="nav-item" role="presentation"><a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false"><?php echo $term->name?></a></li>
          <?php } ?>
      </ul>
            </div>
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
          <div class="course-wrapper">
           ...
           // echo "<pre>";print_r($custom_fields);echo "</pre>";
            ...
            <div class="column">
              <div class="course-card">
                <figure class="image"><img alt="International Graded Guitar Exam Course" src="<?php echo $image_url;?>"></figure>
                <div class="course-copy">
                  <header class="course-header">
