          ...
          <div class="menu-back">
            ...
            <div class="<?php echo vibe_get_container(); ?> d-flex align-items-center justify-content-between" >
                ...
                <?php
                   ...
                   $menuitems = wp_get_nav_menu_items( $menu->term_id, array( 'order' => 'DESC' ) );
                   //print_r($menuitems);
                   echo "<ul class='after_loginspace'><li class='search-icon'><a href='/?s'><img alt='search' src=".get_bloginfo('template_url')."/assets/images/search.svg></a></li>";
                   if (is_user_logged_in()){
                       do_action('woocommerce_add_to_cart_fragments'); 
                       /*do_action('notification_fragments'); */
                    }
                   foreach ($menuitems as $menu) {  ?>
                       <li><a href="<?php echo $menu->url; ?>"><span class="icon"><img alt='epaper' src="<?php bloginfo('template_url'); ?>/assets/images/ePaper-icon.svg"/></span><span class="text"><?php echo $menu->title; ?></span></a></li>
                   <?php }
                   echo "</ul>";
                   ?>
                </div>
