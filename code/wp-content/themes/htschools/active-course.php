            ...
            <div class="col-sm-12 col-lg-3 pull-left mrg">
                <div class="col-lg-12 right-details pull-left mrg">
                  ...
                  <div class="col-lg-12 course-button">
                    ...
                    ?>
                    <?php  
                    echo '<div class="course_home_progress" data-id="'.$post->ID.'"><div><span></span><span>'.$course_progress.'</span></div><div class="progress course_progress"><div class="bar animate stretchRight load" style="width: '.$course_progress.'%; "></div></div></div>'; ?>
