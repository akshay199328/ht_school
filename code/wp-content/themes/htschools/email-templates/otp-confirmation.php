...
<head>
  ...
  <style type="text/css">
    ...
    .code{display:inline-block;margin:0 8px;}
    .footer{}
    @media (max-width:430px){
        .wrapper{padding:30px 20px}
        .code{padding:4px 6px;margin:0 6px}
...
<body style="background-color:#ddd;margin:0;font-family:system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', 'Liberation Sans', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';">
    ...
    <div class="wrapper" style="background-color:#FFF;">
        ...
        <div class="content" style="padding:20px;font-size:18px;">
            ...
            <p style="margin-bottom:30px;line-height:1.5">Please use the OTP <span class="code" style="background-color:#d5ebff;line-height:1;font-weight:500;padding:6px 10px;"><?php  echo $newOTP;?></span> to register on HT School.</p>
            <p style="line-height:1.5;">Happy Learning!<br>
            <span style="font-weight:500">Team HT School</span></p>
        </div>
    </div>
    <div class="footer" style="background-color:#000;color:#FFF;padding:30px;font-size:13px;text-align:center">
        <div class="social" style="font-size:20px;margin-bottom:15px;">
            <a style="color:#FFF;margin-left:10px;text-decoration:none;" href="https://www.linkedin.com/company/htschool">
              <img src="<?php echo get_bloginfo('template_url')?>/assets/images/linkdin.png" />
            </a>
            
            <a style="color:#FFF;margin-left:10px;text-decoration:none;" href="https://twitter.com/htschool1">
              <img src="<?php echo get_bloginfo('template_url')?>/assets/images/twitter.png" />
            </a>
            
            <a style="color:#FFF;margin-left:10px;text-decoration:none;" href="https://www.facebook.com/HTSchool-111960910982690/">
              <img src="<?php echo get_bloginfo('template_url')?>/assets/images/facebook.png" />
            </a>
            
            <a style="color:#FFF;margin-left:10px;text-decoration:none;" href="https://www.instagram.com/htschool/">
              <img src="<?php echo get_bloginfo('template_url')?>/assets/images/instagram.png" />
            </a>
        </div>
        <div>
            <p style="color:#d5ebff;margin:0 0 10px 0;">Copyright © 2021 HTDSL. All rights reserved.</p>
