                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td class="logo" style="text-align: center;">
                                        <h1>
                                            <a href="#"><img src="<?php echo get_bloginfo('template_url')?>/wp-content/uploads/2021/04/Header-logo-big_Web.png"/></a>
                                        </h1>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td valign="middle" class="hero bg_white" style="padding: 0;">
                            <img src="<?php echo get_bloginfo('template_url')?>/wp-content/uploads/2021/04/logo-news-letter.png" alt="" style="width: 100%; max-width: 341px; height: auto; margin: auto; display: block;" />
                        </td>
                    </tr>
                    <!-- end tr -->
                    <tr>
                                    ...
                                    <td valign="middle" style="background-color: #000000;">
                                        <span style="display: block;">
                                            <ul style="display: flex; list-style-type: none; padding: 0;">
                                                <li>
                                                    <a href="#" style="margin-right: 13px;"><img src="<?php echo get_bloginfo('template_url')?>/wp-content/uploads/2021/04/icon-linkedin.svg" /></a>
                                                </li>
                                                <li>
                                                    <a href="#" style="margin-right: 15px;"><img src="<?php echo get_bloginfo('template_url')?>/wp-content/uploads/2021/04/icon-twitter.svg" /></a>
                                                </li>
                                                <li>
                                                    <a href="#" style="margin-right: 15px;"><img src="<?php echo get_bloginfo('template_url')?>/wp-content/uploads/2021/04/icon-facebook.svg" /></a>
                                                </li>
                                                <li>
                                                    <a href="#" style="margin-right: 15px;"><img src="<?php echo get_bloginfo('template_url')?>/wp-content/uploads/2021/04/icon-instagram.svg" /></a>
                                                </li>
                                            </ul>
                                        </span>
                                    </td>
