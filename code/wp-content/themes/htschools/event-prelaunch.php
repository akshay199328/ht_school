  ...
  <div class="section-copy">
    ...
    ?>
      <div class="column view_codeathon_course" data-id="<?php echo $course_1; ?>">
        ...
        <span class="video">
          <a class="play" href="<?php echo get_bloginfo('url'); ?>/course/<?php echo $slug1; ?>">
            <img src="<?php echo get_bloginfo('template_url'); ?>/assets/images/video-play.svg"></a>
      ...
      <?php }else{ ?>
        <?php if($course_status11 == 1){ ?>
          <a class="enroll" href="<?php echo get_bloginfo('url'); ?>/course/<?php echo $slug1; ?>">Start Course</a>
        <?php }else{ ?>
      ...
      <div class="column view_codeathon_course" data-id="<?php echo $course_2; ?>">
        ...
        <?php }else{ ?>
          <?php if($course_status22 == 1){ ?>
            <a class="enroll" href="<?php echo get_bloginfo('url'); ?>/course/<?php echo $slug2; ?>">Start Course</a>
          <?php }else{ ?>
            <button class="enroll" disabled>Enroll Now</button>
          <?php } ?>
        <?php } ?>
      ...
      <div class="column view_codeathon_course" data-id="<?php echo $course_3; ?>">
        ...
        <?php }else{ ?>
          <?php if($course_status33 == 1){ ?>
            <a class="enroll" href="<?php echo get_bloginfo('url'); ?>/course/<?php echo $slug3; ?>">Start Course</a>
          <?php }else{ ?>
            <button class="enroll" disabled>Enroll Now</button>
          <?php } ?>
        <?php } ?>
