                    ...
                    <nav id="navbar" class="navbar navbar-expand-xl p-0">
                     ...
                     <div id="" class="middle-menu col-lg-4">
                        ...
                        ?>
                            ...
                            <a href="<?php echo vibe_site_url('','logo'); ?>" class="logo d-flex align-items-center"><img src="<?php  echo vibe_sanitizer($url,'url'); ?>" alt="<?php echo get_bloginfo('name'); ?>" title="<?php echo get_bloginfo('name'); ?>" /></a>
                        <?php
