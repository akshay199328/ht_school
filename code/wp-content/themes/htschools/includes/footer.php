...
<footer class="footer-wrapper">
    ...
    <script>window.noZensmooth = true</script>
     <link rel='stylesheet' id='acf-datepicker-css'  href='<?php echo get_bloginfo('template_url'); ?>/wp-content/plugins/advanced-custom-fields/assets/inc/datepicker/jquery-ui.min.css?ver=1.11.4' type='text/css' media='all' />

    <script type='text/javascript' src='<?php echo get_bloginfo('template_url'); ?>/wp-includes/js/jquery/ui/datepicker.min.js?ver=1.12.1' id='jquery-ui-datepicker-js'></script>
