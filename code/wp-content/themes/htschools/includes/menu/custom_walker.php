                  ...
                  if(!empty($item->taxonomy)){
                      ...
                      if(!empty($term_array)){
                        $item_output .= '<ul class="taxonomy_menu '.$item->taxonomy.'_menu">';
                          ...
                          if(isset($t['children'])){
                            $item_output .='<div class="sub_cat_menu column'.$item->columns.' '.$item->taxonomy.'_'.(empty($t['term']['slug'])?'':$t['term']['slug']).'_menu "><div class="taxonomy_submenu"><div class="row">';
                        ...
                        if(!is_wp_error($terms)){
                          foreach($terms as $term){
                            if(!in_array($term->slug,$hide_terms)){
                              ...
                              $item_output .='<div class="sub_cat_menu sub_posts_menu column'.$item->columns.'"><div class="taxonomy_submenu '.$item->taxonomy.'_'.$term->slug.'_menu"><div class="row">';
                              ...
                              while ( $query->have_posts() ) : $query->the_post();
                                ...
                                if(has_post_thumbnail()){ 
                                  $item_output .= get_the_post_thumbnail($post->ID,'small'); 
                                }
