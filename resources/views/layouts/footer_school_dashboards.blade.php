   	...
   	<div class="new-footer-copy">
      	...
      	<div class="new-footer-top">
            <svg viewBox="0 0 168.5 46.323" xmlns="http://www.w3.org/2000/svg">
         	...
         	<div class="social">
                <a target="_blank" href="https://www.facebook.com/HTSchool-111960910982690/" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a>

                <a target="_blank" href="https://twitter.com/htschool1" class="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a>

                <a target="_blank" href="https://www.linkedin.com/company/htschool" class="linkedin"><i class="fa fa-linkedin" aria-hidden="true"></i></a>

                <a target="_blank" href="https://www.youtube.com/user/ht" class="youtube"><i class="fa fa-youtube-play" aria-hidden="true"></i></a>

                <a target="_blank" href="https://www.instagram.com/htschool/" class="instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a>

                <a target="_blank" href="https://ht.fortune4.org/feed/" class="rss"><i class="fa fa-rss" aria-hidden="true"></i></a>
         	</div>
      	</div>
      	<div class="new-footer-links">
         	<div class="column">
                <div class="menu-footer-left-menu-container">
                	<ul id="menu-footer-left-menu" class="menu">
                      <li id="menu-item-6168" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6168"><a href="https://ht.fortune4.org/courses/">Explore Courses</a></li>
                      <li id="menu-item-6169" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6169"><a href="https://ht.fortune4.org/editorsdesk/">Editor’s Desk</a></li>
                      <li id="menu-item-6171" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6171"><a href="https://ht.fortune4.org/about/">About HT Schools</a></li>
                      <li id="menu-item-6170" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6170"><a href="https://ht.fortune4.org/contact-us/">Contact Us</a></li>
                      <li id="menu-item-6344" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6344"><a href="https://ht.fortune4.org/become-a-course-partner/">Become a Course partner</a></li>
                      <li id="menu-item-6345" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6345"><a href="https://ht.fortune4.org/become-a-partner/">Become A Part Of</a></li>
                   </ul>
                </div>
         	</div>
         	<div class="column">
                <div class="menu-footer-left-menu-container">
                	<ul id="menu-footer-left-menu" class="menu">
                      ...
                      <li id="menu-item-6164" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6164"><a href="https://www.htcodeathon.com/">Codeathon</a></li>
                      ...
                      <li id="menu-item-8413" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8413"><a href="https://ht.fortune4.org/parent-login/">View child&#8217;s progress</a></li>
                      <li id="menu-item-8414" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8414"><a href="https://ht.fortune4.org/school-login/">School Login</a></li>
                   </ul>
                </div>
         	</div>
         	<div class="column">
                <div class="menu-footer-left-menu-container">
                	<ul id="menu-footer-left-menu" class="menu">
                      <li id="menu-item-2063" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2063"><a title="Cookie Policy" href="https://ht.fortune4.org/cookie-policy/">Cookie Policy</a></li>
                      <li id="menu-item-886" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-886"><a title="Privacy Policy" href="https://ht.fortune4.org/privacy-policy/">Privacy Policy</a></li>
                      <li id="menu-item-887" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-887"><a title="Terms of Use" href="https://ht.fortune4.org/terms-of-use/">Terms of Use</a></li>
                   </ul>
                </div>
         	</div>
         	<div class="column newsletter">
                ...
                <section id="text-7" class="widget widget_text">
                   	<div class="textwidget">
                      	<div role="form" class="wpcf7" id="wpcf7-f6589-o1" lang="en-US" dir="ltr">
                         	<div class="screen-reader-response">
                                <p role="status" aria-live="polite" aria-atomic="true"></p>
                                <ul></ul>
                         	</div>
                         	<form action="" method="post" class="wpcf7-form init" novalidate="novalidate" data-status="init">
                                <input type="email" name="your-email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" id="emailAddress" aria-required="true" aria-invalid="false" placeholder="Email" /></span> </label></p>
                                <p><input type="submit" value="Send" class="wpcf7-form-control wpcf7-submit" id="submit-email" /></p>
   		...
   		<div class="copyright">
   			Copyright © 2021 HTML. All rights reserved.
		</div>
	</div>
</footer>
<!-- ======= Footer ======= -->
...
<script type="text/javascript" src="asset/js/school-datatables.js"></script>
