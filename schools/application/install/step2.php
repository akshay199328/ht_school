    ...
    <div class="col-md-12">
       <hr>
        ...
        if (version_compare(PHP_VERSION, '7.1.3') >= 0) {
            $ltext .= 'To Run '.$app_name.' You need at least PHP version 7.1.3, Your PHP Version is: ' . PHP_VERSION . " Tested <strong>---PASSED---</strong><br/>";
            $passed .= '1';

        } else {
            $ltext .= 'To Run '.$app_name.' You need at least PHP version 7.1.3, Your PHP Version is: ' . PHP_VERSION . " Tested <strong>---FAILED---</strong><br/>";
            $passed .= '0';
