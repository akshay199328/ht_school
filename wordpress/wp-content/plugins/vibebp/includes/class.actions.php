...
class VibeBP_Actions{
	...
	private function __construct(){
		...
		add_action('wp_head',array($this,'vibebp_wp_login'),999);
        ...
        //add_action('wp_footer',array($this,'add_single_member'));
	}

	function add_single_member(){
		?>
		<div id="single_member_profile"></div>
		<?php
