...
class lms_settings{
	...
	function lms_general_settings(){
		...
		switch($_GET['sub']){
			...
			default:
				...
				array(
						'label' => __('Enable Assign quiz Feature','wplms'),
						'name' =>'enable_assign_quiz',
						'class' => '',
						'type' => 'checkbox',
						'desc' => __('Will allow instructor to assign quizzes to users','wplms') 
					),
				...
				array(
						'label' => __('Open Login popup for non logged in users when they click on take this course button(For all courses)','wplms').'[ Legacy ]',
	...
	*/
	function lms_registration_forms(){
		...
		echo '<p>'.sprintf(__('Build registration forms for Students and Instructors, refer %s tutorial %s','wplms'),'<a href="http://vibethemes.com/documentation/wplms/knowledge-base/custom-registration-forms-in-wplms/">','</a>').'</p>';
