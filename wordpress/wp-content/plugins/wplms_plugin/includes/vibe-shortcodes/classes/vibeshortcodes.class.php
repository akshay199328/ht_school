...
class VibeShortcodes {
    ...
    private function __construct(){
    	...
    	define('VIBE_TINYMCE_URI', WPLMS_PLUGIN_INCLUDES_URL.'/vibe-shortcodes/tinymce');
	...
	{      
        if((is_admin() && in_array( $hook, array( 'post-new.php', 'post.php','toplevel_page_wplms_options' ) ) ) ){
	        ...
	        wp_localize_script( 'jquery', 'VibeShortcodes', array('shortcodes_folder' => WPLMS_PLUGIN_INCLUDES_URL .'/vibe-shortcodes') );
	        if ( floatval(get_bloginfo('version')) >= 3.9){
