...
document.addEventListener('click', function (event) {
    ...
    if (hasClasss(event.target, 'submit_registration_form') || hasClasss(event.target.parentElement, 'submit_registration_form')) {
      ...
      if(hasClasss(event.target.parentElement, 'submit_registration_form')){
        ...
        console.log(parent.querySelector('.message'));
        ...
        xhr.send(encodeURI('action=wplms_register_user&security=' + document.getElementById('bp_new_signup').value+'&name='+parent.getAttribute('data-form-name')+'&settings='+JSON.stringify(settings)));
    }
}, false);